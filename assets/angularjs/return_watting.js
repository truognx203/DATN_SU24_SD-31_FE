let urlAllWatting = "http://localhost:8080/api/return-ex/return-ex-receive-watting"
let urlDetailWatting = "http://localhost:8080/api/return-ex/return-ex"
let urlAddorUpdateWatting = "http://localhost:8080/api/return-ex/return-ex-add-or-update"
window.ReturnWattingChangeControler = function($scope, $http, $location,$routeParams){
    $scope.sortBy = ''
    $scope.IsSortBy = ''
    $scope.sortCode = true
    ...
    $scope.getAll = function(){
        ...
        $http.get(urlAllWatting).then(function (response){ 
